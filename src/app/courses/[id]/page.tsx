  ...
  return (
    <main className="min-h-screen bg-gray-50 px-6 py-10">
      <div className="mx-auto max-w-5xl">
        <Link href="/courses" className="text-sm font-medium text-gray-600">
          ← Back to Courses
        </Link>
        ...
        <div className="mt-6 rounded-3xl bg-white p-8 shadow">
          ...
          {isEnrolled ? (
            ...
            <button
              ...
              disabled={enrolling}
              className="mt-10 rounded-xl bg-black px-8 py-4 font-semibold text-white hover:bg-gray-800 disabled:opacity-60"
            >
